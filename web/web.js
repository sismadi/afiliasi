...
data:[
  {id:1,nama:'Web Development',gambar:'womankode',isi:'<div class="col-1-2"><a href="#" onclick="ref.getRef(1)" class="button">Detail</a></div><div class="col-1-2"><a href="#" class="button">Ambil</a></div>'},
  {id:2,nama:'DonatJS Framework',gambar:'womandesign',isi:'<div class="col-1-2"><a href="#" onclick="ref.getRef(2)" class="button">Detail</a></div><div class="col-1-2"><a href="#" class="button">Ambil</a></div>'},
  {id:3,nama:'Education & Mentorship',gambar:'manandroid',isi:'<div class="col-1-2"><a href="#" onclick="ref.getRef(3)" class="button">Detail</a></div><div class="col-1-2"><a href="#" class="button">Ambil</a></div>'},
  {id:4,nama:'Career in Tech',gambar:'mansamping',isi:'<div class="col-1-2"><a href="#" onclick="ref.getRef(4)" class="button">Detail</a></div><div class="col-1-2"><a href="#" class="button">Ambil</a></div>'},
