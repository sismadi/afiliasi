...
warnass={
  gradient1:['#264653','#2a9d8f','#e9c46a','#f4a261','#e76f51'],
  gradient2:['#ccd5ae','#e9edc9','#fefae0','#faedcd','#d4a373'],
  gradient3:['#fe218b','#fed700','#21b0fe','#ead7c3','#black'],
  gradient4:['#26547c','#ef476f','#ffd166','#ead7c3','#black'],
  gradient5:['#540d6e','#ffb400','#00a6ed','#ead7c3','#black'],
}
...
// fill=[`#264653`,`#2a9d8f`,`#e9c46a`,`#f4a261`,`#e76f51`,`black`,`#cfecf7`,`#fee0bc`];
// fill=[`#e63946`,`#f1faee`,`#a8dadc`,`#457b9d`,`#1d3557`,`black`,`#cfecf7`,`#fee0bc`];
// fill=[`#344e41`,`#3a5a40`,`#588157`,`#a3b18a`,`#dad7cd`,`black`,`#cfecf7`,`#fee0bc`];
// fill=[`#ff595e`,`#ffca3a`,`#8ac926`,`#1982c4`,`#6a4c93`,`black`,`#cfecf7`,`#fee0bc`];


// fill=[`url('#gradient')`,`url('#gradient1')`,`url('#gradient2')`,`url('#gradient3')`,`url('#gradient4')`];
// fill=['#264653','#2a9d8f','#e9c46a','#f4a261','#e76f51'];

// fill=warnas;
fill=[warnas[0],warnas[1],warnas[2],warnas[3],warnas[4]];

// fill=[`url('#gradient')`,`url('#gradient1')`,`navy`,`#fee0bc`,`black`,`url('#gradient1')`, `#cfecf7`,`#c4b3a4`];
...
{position:position[0],fill:fill[5],path:path.sepatu1},
{position:position[2],fill:fill[5],path:path.sepatu1},
...
{position:'0,-7',fill:fill[5],path:path.sepatu1},
{position:'-5,-7',fill:fill[5],path:path.sepatu1},
],
...
// {position:position[0],fill:fill[1],path:path.manbawah1},
// {position:position[0],fill:fill[4],path:path.ibaju4},
...
out+=`<div onclick="img.controller.modal(${i})" class="wow" id="svg${i}">`;
...
out= `<svg id="${id}"  height="200px" width="200px" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 30 30">`;
